...
export default function OTPModal({
  ...
  return (
    <div className="flex items-center justify-center h-screen w-screen">
      {nameModal == true ? (
        <div className="flex justify-center flex-col items-center w-[400px] px-[40px] shadow-[0_0_20px_5px_rgba(0,0,0,0.15)] text-gray-400 bg-gray-800 py-[32px] border-1 border-gray-700">
          <div>
            <svg
              className="w-35 mb-6"
              viewBox="0 0 94 32"
            ...
            >
              <defs>
                ...
                >
                  ...
                  <stop stop-color="#357DE8" offset="100%"></stop>
                </linearGradient>
              </defs>
              <path
                fill="#FFFFFF"
          ...
          <div className="flex flex-col items-center justify-center font-medium">
            ...
            <div className="text-[13px]">Finish setting up your account</div>
          </div>
          <div className="self-start font-medium mt-4 text-gray-400">
            <div className="text-xs">Email address</div>
            <div className=" text-sm font-bold">{email}</div>
          </div>
          <div className="self-start w-full text-xs my-4 mb-2 items-start">
            <div className="font-semibold">First Name</div>
            <div>
              <input
                type="text"
                className="py-2 text-sm  mt-1 mb-3 px-3 rounded border border-gray-600 w-full"
                value={firstname}
                onChange={(e) => {
            ...
            <div>
              <input
                type="text"
                className="py-2 text-sm px-3 rounded border mt-1 mb-3 border-gray-600 w-full"
            ...
            <div className="text-[10px] text-gray-400 mt-2 flex flex-wrap items-center w-[350px] justify-center">
              <div>By signing up, I accept the Atlassian </div>
              <a
              ...
              >
                <div>Cloud Terms of Service</div>
                <div>
                  <svg
                    className="h-[9px]"
                    viewBox="0 0 20 20"
          ...
          <button
            ...
            className={`bg-blue-600 py-2 px-15 w-full rounded mb-4 transition-all duration-200 ${
              loading
            ...
            >
              <defs>
                ...
                >
                  ...
                  <stop stopColor="#93BBFD" offset="100%" />
                </linearGradient>
              </defs>
              <g stroke="none" strokeWidth="1" fill="#9CA3AF">
                <path
                  fill="url(#uid21)"
          ...
          <div className="text-[10px] text-gray-400 my-2 flex gap-1 items-center justify-center w-full">
        ...
        <div className="flex justify-center flex-col items-center w-[400px] px-[40px] shadow-[0_0_20px_5px_rgba(0,0,0,0.15)] text-gray-400 bg-gray-800 py-[32px] border-1 border-gray-700">
          ...
          <div className="font-medium text-2xl mb-3">
            We've emailed you a code test
          </div>
          <div className="text-sm font-medium mb-1 text-gray-400">
            To complete your account setup, enter the code we've sent to:
          </div>
          <div className="text-lg font-semibold w-full">{email}</div>
          <div className=" my-4 mb-2 items-start">
            <OTPInput
              value={otp}
              dark={true}
