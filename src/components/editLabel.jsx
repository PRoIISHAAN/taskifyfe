...
export function EditLabel(props) {
  const [title, setTitle] = useState(props.editLabel.title);
  const [color, setColor] = useState(props.editLabel.color);
    ...
    <div className="py-3">
      <div className="flex justify-between items-center px-3 w-full">
        <div
          ...
          onClick={() => props.setEditLabel(false)}
        >
          <svg
            width="24"
            height="24"
      ...
      <div className="px-3">
        ...
        <div className="w-full flex items-center justify-between rounded mt-3 mb-1 text-sm text-[13px]">
          <button
            onClick={saveChanges}
            className="bg-blue-400 text-sm font-medium px-3 cursor-pointer hover:bg-[#85b8ff] py-1.5 rounded text-[#252327]"
          >
            Save
          </button>
          <button
            onClick={removeLabel}
            className="bg-[#f9726b] text-sm font-medium hover:bg-[#fc9089] cursor-pointer px-3 py-1.5 rounded text-[#252327]"
          >
            Delete
          </button>
        </div>
