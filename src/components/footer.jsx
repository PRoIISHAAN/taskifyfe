export default function Footer() {
  return (
    <div className="bg-blue-900 text-white flex flex-col items-center justify-center py-4">
      <div className="flex">
        ...
        <div className="min-w-[230px] max-w-[230px] hover:bg-white/10 pl-4 pt-4 pb-6">
          <div>About Trello</div>
          <div className="text-xs my-2">What's behind the boards.</div>
        </div>
        <div className="min-w-[230px] max-w-[230px] hover:bg-white/10 pl-4 pt-4 pb-6">
          <div>Jobs</div>
          <div className="text-xs my-2">
            Learn more about open roles on the Trello team
          </div>
        </div>
        <div className="min-w-[230px] max-w-[230px] hover:bg-white/10 pl-4 pt-4 pb-6">
          <div>Apps</div>
      ...
      <div className="flex justify-between items-center mt-5 mb-1">
        ...
        <div className="text-xs mx-3 cursor-pointer hover:underline">Notice at Collection</div>
        <div className="text-xs mx-3 cursor-pointer hover:underline"> Privacy Policy</div>
        <div className="text-xs mx-3 cursor-pointer hover:underline">Terms</div>
        <div className="text-xs mx-3 mr-35"> Copyright © 2024 Atlassian</div>
        <div className="flex items-center justify-center mx-9">
          <div className="border-2 p-[4px] rounded-full group mx-4">
            <svg height="12" viewBox="0 0 16 16" className="group-hover:scale-85 transition-all duration-100" width="12" fill="currentColor">
          ...
          <div className="border-2 p-[4px] rounded-full group mx-4">
            <svg height="12" className="group-hover:scale-85 transition-all duration-100" width="12"  viewBox="0 0 8 16" fill="currentColor"> 
          ...
          <div className="border-2 p-[4px] rounded-full group mx-4">
            <svg height="12" className="group-hover:scale-85 transition-all duration-100" width="12" viewBox="0 0 16 16" fill="currentColor">
              <g>
          ...
          <div className="border-2 p-[4px] rounded-full group mx-4">
            <svg  viewBox="0 0 20 16" height="12" className="group-hover:scale-85 transition-all duration-100" width="12" fill="currentColor">
          ...
          <div className="border-2 p-[4px] rounded-full group mx-4">
            <svg height="12" className="group-hover:scale-85 transition-all duration-100" width="12" viewBox="0 0 20 14" fill="currentColor">
