export function AddNew() {
  return (
    ...
    <div className="flex  gap-2 hover:bg-gray-400/30  px-2 py-1.5 rounded-lg items-center justify-start w-full max-w-sm cursor-pointer transition-all duration-100">
      <div className="">
        <svg
