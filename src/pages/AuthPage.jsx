...
export function AuthPage() {
  ...
  useEffect(() => {
    ...
    if (Authtype == "login"&&loading==true) {
      Login();
    } else if (Authtype == "signup"&&loading==true) {
      Signup();
    }
    res
  }, [loading, nextPath]);
  ...
  return (
    <div
      style={{
        backgroundImage:
          "url(https://id-frontend.prod-east.frontend.public.atl-paas.net/assets/trello-left.4f52d13c.svg), url(https://id-frontend.prod-east.frontend.public.atl-paas.net/assets/trello-right.e6e102c7.svg)",
    ...
    >
      <div className="flex justify-center flex-col items-center w-[400px] px-[40px] shadow-[0_0_20px_5px_rgba(0,0,0,0.15)] bg-white py-[32px] border-1 border-gray-100">
        <div>
          <svg
            className="w-35 mb-6"
            viewBox="0 0 94 32"
        ...
        <div className="font-medium mb-3">
          {Authtype == "login" && "Log in to continue"}{" "}
          {Authtype == "signup" && "Sign up to continue"}
        </div>
        <div className="flex flex-col items-start w-full">
          <label className="text-xs font-medium mb-1" htmlFor="email">
            Email
          </label>
          <input
            onChange={(e) => {
              setParamEmail(e.target.value);
            }}
            value={paramEmail}
            className="border py-2 w-full px-2 rounded"
            type="email"
        ...
        {Authtype == "login" && (
          <div className="flex justify-start items-center w-full px-2 mt-3 gap-2">
            <input
              type="checkbox"
              className=""
              name="rememberme"
          ...
          <div>
            <p className="text-center text-[11px] text-gray-700 mt-3">
              ...
              <a
                ...
                target="_blank"
                className="text-blue-600 text-[11px] hover:underline inline-flex items-center"
              >
              ...
              >
                ...
                >
                  <path d="M17.5715 3.95926L10.7587 10.772C10.5546 10.9692 10.2811 11.0784 9.99723 11.0759C9.71338 11.0734 9.44185 10.9596 9.24113 10.7589C9.04041 10.5581 8.92655 10.2866 8.92409 10.0027C8.92162 9.7189 9.03074 9.44543 9.22794 9.24125L16.0407 2.4285H14.3237C14.0366 2.4285 13.7613 2.31444 13.5582 2.11142C13.3552 1.90839 13.2411 1.63303 13.2411 1.34591C13.2411 1.05879 13.3552 0.783424 13.5582 0.580399C13.7613 0.377373 14.0366 0.263314 14.3237 0.263314H18.4981C18.5509 0.254962 18.6043 0.250507 18.658 0.250041C18.8017 0.248792 18.9443 0.276183 19.0773 0.330617C19.2104 0.385051 19.3313 0.465437 19.4329 0.567084C19.5346 0.668732 19.6149 0.789606 19.6694 0.922652C19.7238 1.0557 19.7512 1.19825 19.75 1.342C19.7495 1.3956 19.7451 1.44896 19.7367 1.50165V5.67628C19.7367 5.9634 19.6227 6.23877 19.4196 6.44179C19.2166 6.64482 18.9412 6.75888 18.6541 6.75888C18.367 6.75888 18.0916 6.64482 17.8886 6.44179C17.6856 6.23877 17.5715 5.9634 17.5715 5.67628V3.95926Z"></path>
                  <path d="M2.41519 17.5848V2.4285H8.91076V0.263314H2.41194C1.22001 0.263314 0.25 1.23007 0.25 2.42201V17.5913C0.250574 18.1638 0.47834 18.7127 0.883283 19.1175C1.28823 19.5222 1.83724 19.7497 2.40978 19.75H17.5769C17.8608 19.7499 18.1418 19.6938 18.404 19.585C18.6662 19.4762 18.9044 19.3168 19.105 19.116C19.3055 18.9151 19.4646 18.6767 19.573 18.4143 19.6814 18.152 19.737 17.8708 19.7367 17.587V11.0893H17.5715V17.5848H2.41519Z"></path>
                </svg>
              </a>
              .
            </p>
        ...
        <button
          ...
          className={`bg-blue-600 py-2 px-15 w-full rounded my-4 transition-all duration-200 ${
            loading
              ? "cursor-not-allowed bg-blue-700 "
              : "hover:bg-blue-700 cursor-pointer"
          }`}
        >
          <div className="text-white font-medium w-full h-full">
            {loading ? (
        ...
        <div className="flex flex-col w-full gap-4 mt-2">
          <button className="border flex gap-2 items-center cursor-pointer hover:bg-gray-50 transition-all duration-100 justify-center py-2 rounded border-gray-400/70">
            <div>
              <img
                className="size-6"
        ...
        {Authtype == "login" && (
          <div className="flex gap-3 mt-7 mb-4 items-center justify-center">
        ...
        {Authtype == "signup" && (
          <div className="mt-4 mb-4">
            <a className="text-blue-600 text-[12px] hover:underline " href="">
              Already have an Atlassian account? Log in
            </a>
          </div>
        )}

        <div className="m-auto w-full text-gray-400/80">
          <hr />
        </div>
        <div>
          <svg
        ...
        <div className="text-[10px] text-gray-700 my-2 flex gap-1 items-center justify-center w-full">
          <div>One account for Trello, Jira, Confluence and </div>
          <a
            className="flex justify-center items-center text-blue-600 underline"
            href="https://support.atlassian.com/atlassian-account/docs/what-is-an-atlassian-account/"
          >
            <div>more.</div>
            <div>
              <svg className="h-[9px]" viewBox="0 0 20 20" fill="currentColor">
                <path d="M17.5715 3.95926L10.7587 10.772C10.5546 10.9692 10.2811 11.0784 9.99723 11.0759C9.71338 11.0734 9.44185 10.9596 9.24113 10.7589C9.04041 10.5581 8.92655 10.2866 8.92409 10.0027C8.92162 9.7189 9.03074 9.44543 9.22794 9.24125L16.0407 2.4285H14.3237C14.0366 2.4285 13.7613 2.31444 13.5582 2.11142C13.3552 1.90839 13.2411 1.63303 13.2411 1.34591C13.2411 1.05879 13.3552 0.783424 13.5582 0.580399C13.7613 0.377373 14.0366 0.263314 14.3237 0.263314H18.4981C18.5509 0.254962 18.6043 0.250507 18.658 0.250041C18.8017 0.248792 18.9443 0.276183 19.0773 0.330617C19.2104 0.385051 19.3313 0.465437 19.4329 0.567084C19.5346 0.668732 19.6149 0.789606 19.6694 0.922652C19.7238 1.0557 19.7512 1.19825 19.75 1.342C19.7495 1.3956 19.7451 1.44896 19.7367 1.50165V5.67628C19.7367 5.9634 19.6227 6.23877 19.4196 6.44179C19.2166 6.64482 18.9412 6.75888 18.6541 6.75888C18.367 6.75888 18.0916 6.64482 17.8886 6.44179C17.6856 6.23877 17.5715 5.9634 17.5715 5.67628V3.95926Z"></path>
                <path d="M2.41519 17.5848V2.4285H8.91076V0.263314H2.41194C1.22001 0.263314 0.25 1.23007 0.25 2.42201V17.5913C0.250574 18.1638 0.47834 18.7127 0.883283 19.1175C1.28823 19.5222 1.83724 19.7497 2.40978 19.75H17.5769C17.8608 19.7499 18.1418 19.6938 18.404 19.585C18.6662 19.4762 18.9044 19.3168 19.105 19.116C19.3055 18.9151 19.4646 18.6767 19.573 18.4143C19.6814 18.152 19.737 17.8708 19.7367 17.587V11.0893H17.5715V17.5848H2.41519Z"></path>
              </svg>
            </div>
        ...
        <div className="text-[11px] text-center text-gray-600 mt-2">
          ...
          <a
            ...
            target="_blank"
            className="underline text-blue-600 hover:no-underline inline-flex items-center"
          >
            Privacy Policy
            <svg
              className="w-[9px] h-[9px] ml-1 inline-block"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="currentColor"
